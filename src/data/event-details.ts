...
export const mockEventDetails: EventDetailsData = {
  ...
  description: 'Join us for an unforgettable night with Africa’s premier DJ, DJ Jimmy Jat, spinning the hottest tracks live in Lagos. Experience elite sound, spectacular light shows, and premium VIP lounges.',
...
export const mockEventReviews: EventReview[] = [
  {
    ...
    rating: 5,
    comment: 'Absolutely legendary night! The sound setup was incredible and DJ Jimmy Jat was on fire.',
    date: '3 days ago'
  },
  {
    id: 'r2',
    ...
    rating: 4,
    comment: 'Great atmosphere and crowd. Premium section was highly organized. Will definitely attend the next edition.',
    date: '1 week ago'
  }
];